...
print(threeClass.CuriseAssistEnabled,threeClass.name,threeClass.model,threeClass.year)
...
threeClass.start();     threeClass.stop();  threeClass.drive()

fiveClass.Display();        threeClass.Display()